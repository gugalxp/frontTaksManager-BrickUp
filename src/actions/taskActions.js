...
export const DELETE_TASK_SUCCESS = 'DELETE_TASK_SUCCESS'; // Added action for deletion success
export const DELETE_TASK_FAILURE = 'DELETE_TASK_FAILURE'; // Added action for deletion failure
